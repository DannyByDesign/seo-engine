...
- [publication-playbook.md](../../shared/seo-references/publication-playbook.md) §7 (metrics and
  the named-vs-cited distinction), §4 (where refresh fits in the loop).
- [geo-playbook.md](../../shared/seo-references/geo-playbook.md) §9 (measurement discipline), §10
  (Bing feeds ChatGPT: indexing is a GEO precondition).
- [red-flags.md](../../shared/seo-references/red-flags.md) §3 (no freshness faking), §7.
- [api-reference.md](../../shared/seo-references/api-reference.md) — Search Console setup.
