...
def detect(repo_root: Path) -> dict:
    ...
    return {
        ...
        "next_step": (
            "Inspect existing config and preserve owner choices. Reuse established site_url; "
            "otherwise corroborate hosting config with live canonical/site identity. Ask only "
            "if production identity remains ambiguous. Merge evidenced source/build settings, "
            "then use seo-growth for business understanding and market research."
        ),
    }
