...
- **`numeric_anchors` should be in the teens** for a full long read; single digits mean the
  outline had few verified numbers — fix upstream in `pub-research`, not by editing prose.
...
- [red-flags.md](../seo-references/red-flags.md) §3 (no AI-content penalty; the shredder's
  purpose), §7 (honest mentions).
- [geo-playbook.md](../seo-references/geo-playbook.md) §5 (why sourced statistics and
