...
- [api-reference.md](../seo-references/api-reference.md) — Ahrefs API v3,
  DataForSEO sections: auth model, endpoint shapes, plan/rate-limit gating.
- [seo-playbook.md](../seo-references/seo-playbook.md) §5 — the "don't
  silently break existing equity" principle a broken backlink is one instance of.
- [red-flags.md](../seo-references/red-flags.md) §1 and §4.
- [geo-playbook.md](../seo-references/geo-playbook.md) §6.
