...
Per [seo-playbook.md §6](../seo-references/seo-playbook.md): internal links are how both crawlers
...
an orphan) is legitimate ([red-flags.md §1](../seo-references/red-flags.md)).
...
- Never treat "this page has no inbound links" as license to add reciprocal links indiscriminately
  ...
  ([red-flags.md §1](../seo-references/red-flags.md)).
...
- Never claim schema.org/JSON-LD or `llms.txt` help internal-linking goals — out of scope; see
  [geo-playbook.md §§1, 3](../seo-references/geo-playbook.md) and redirect to `geo-optimize`.
...
- [seo-playbook.md](../seo-references/seo-playbook.md) §6 — this skill's entire scope: no-orphans
...
- [red-flags.md](../seo-references/red-flags.md) §1 (link spam / link schemes — why nothing here
