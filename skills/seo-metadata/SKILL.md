...
- Before/after a CMS migration or redesign, a common casualty ([red-flags.md §4](../seo-references/red-flags.md)).
...
doorway pattern — [red-flags.md §1](../seo-references/red-flags.md)); a shared structural pattern
is fine, a shared sentence with one word swapped is not. No keyword-density targets
([seo-playbook.md §9](../seo-references/seo-playbook.md)). Keep within the checked length bounds
...
([geo-playbook.md §3](../seo-references/geo-playbook.md); [red-flags.md §5](../seo-references/red-flags.md)).
...
- [seo-playbook.md](../seo-references/seo-playbook.md) §1 (people-first — the test every rewritten
  title/description must pass), §9 (no keyword-density targets).
- [red-flags.md](../seo-references/red-flags.md) §1 (scaled content / doorway pages), §4
  (accidental noindex and post-migration regressions — why noindex pages are filtered out here).
- [geo-playbook.md](../seo-references/geo-playbook.md) §3 — no proven AI-citation benefit for
