...
- [api-reference.md](../seo-references/api-reference.md) — GSC method and
...
- [geo-playbook.md](../seo-references/geo-playbook.md) §5 — the one
  evidence-backed content-improvement tactic (citations/quotes/statistics).
- [red-flags.md](../seo-references/red-flags.md) §1 (scaled content abuse,
