...
|---|---|---|---|
| `state/crawls/` (shared snapshot store) | consumes (via `--changed-from-snapshots`) | see [common-setup.md § Snapshot contract](../seo-references/common-setup.md) | this skill + any other |
...
- [seo-playbook.md](../seo-references/seo-playbook.md) §5 — canonicalization/indexing hygiene;
  why declared-vs-selected canonical diffing is a legitimate automated check.
- [red-flags.md](../seo-references/red-flags.md) §4 — IndexNow misconceptions, canonical
  hijacking, accidental noindex; all directly govern this skill's behavior.
- [geo-playbook.md](../seo-references/geo-playbook.md) §10 — Bing as ChatGPT's search index; the
