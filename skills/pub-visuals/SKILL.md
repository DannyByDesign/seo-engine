...
- [publication-playbook.md](../seo-references/publication-playbook.md) §2 (images with
  dimensions, self-hosted), §3 (diagram and cover conventions), §8 (the vendor's Canvas).
- [seo-playbook.md](../seo-references/seo-playbook.md) §3 (image dimensions and lazy loading
  behind the CLS numbers the builder protects).
- [api-reference.md](../seo-references/api-reference.md) — image providers.
