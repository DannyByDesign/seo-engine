...
- [common-setup.md](../seo-references/common-setup.md) — paths, config resolution.
- [geo-playbook.md](../seo-references/geo-playbook.md) §9 (measurement methodology — the basis
...
- [red-flags.md](../seo-references/red-flags.md) §5 — cloaking risk extends to AI crawlers;
