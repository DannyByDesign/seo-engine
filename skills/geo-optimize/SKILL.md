...
|---|---|---|---|
| `state/crawls/` (shared snapshot store) | consumes/produces | see [common-setup.md § Snapshot contract](../seo-references/common-setup.md) | this skill + any other |
...
- [geo-playbook.md](../seo-references/geo-playbook.md) §1 (llms.txt), §4 (per-vendor crawler
...
- [red-flags.md](../seo-references/red-flags.md) §1 (Cloaking) and §5 (GEO-specific gotchas) —
