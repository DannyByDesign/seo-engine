...
- [publication-playbook.md](../seo-references/publication-playbook.md) §4 (the strategy
  substrate and how each field is consumed), §6 (mention policy fields), §8 (the vendor's
  Strategy capability this mirrors).
- [red-flags.md](../seo-references/red-flags.md) §7 (mentions stay honest; competitors named
  fairly or not at all).
- [api-reference.md](../seo-references/api-reference.md) — DataForSEO volume/difficulty,
  LLM providers.
