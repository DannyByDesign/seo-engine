...
- [api-reference.md](../../shared/seo-references/api-reference.md) — PageSpeed Insights
  / CrUX API auth, quotas, field-vs-lab response shape.
- [seo-playbook.md](../../shared/seo-references/seo-playbook.md) §3 — Core Web Vitals
  thresholds and how CWV weighs against content quality.
- [red-flags.md](../../shared/seo-references/red-flags.md) §6 — the meta-rule.
