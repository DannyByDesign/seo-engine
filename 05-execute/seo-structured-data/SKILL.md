...
|---|---|---|---|
| `state/crawls/` (shared snapshot store) | consumes (live mode URL discovery) | see [common-setup.md § Snapshot contract](../../shared/seo-references/common-setup.md) | this skill + any other |
...
- [seo-playbook.md](../../shared/seo-references/seo-playbook.md) §4 (E-E-A-T — governs the author-value
  guardrail), §8 (structured data's real, traditional-SEO value).
- [geo-playbook.md](../../shared/seo-references/geo-playbook.md) §3 — why this skill must never be sold as
  a GEO lever.
- [red-flags.md](../../shared/seo-references/red-flags.md) §1 (Cloaking), §6 (the meta-rule for any
